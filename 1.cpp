...
void postprocessResults(std::vector<void *> buffers, std::vector<nvinfer1::Dims> &dims, int batch_size)
{
    ...
    std::cout<<"output2 "<<cpu_outputs[1].data()<<std::endl;
    std::cout<<"output3 "<<cpu_outputs[2].data()<<std::endl;
    ...
    std::cout<<"output4 "<<cpu_outputs[3].size()<<std::endl;
    std::cout<<"output5 "<<cpu_outputs[4].size()<<std::endl;
    std::cout<<"output6 "<<cpu_outputs[5].size()<<std::endl;
...
int main(int argc, char* argv[])
{
   ...
   // std::vector<std::vector<nvinfer1::Dims> output_dims;
    ...
    double infer_time = (double)(end_time-begin_time)/CLOCKS_PER_SEC;
